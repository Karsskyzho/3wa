<?php
    ...
    class ConnectionManager extends AbstractModel
    {
        ...
        public function userConnection(int $id, string $username, string $firstname, string $userBirthday, string $password, string $email, string $address, string $userRegion, string $userDepartement, string $city ): void
        {
            $_SESSION['id'] = $id;
